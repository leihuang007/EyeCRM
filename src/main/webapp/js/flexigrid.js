...
(function ($) {
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			query: '',
			qtype: '',
			queryForm : false,// add by huanglei,the form contains customer search conditions.
	        nomsg: '没有查到结果。',
		...
		var g = {
			...
			doSearch: function () {
				...
				}else{//add by huanglei,customer search.
					p.query = $("form[id='search_form']").serialize();
				}
				p.newp = 1;
				this.populate();
			},
		...
		//add by huanglei ,customer search
		if(p.queryForm){
